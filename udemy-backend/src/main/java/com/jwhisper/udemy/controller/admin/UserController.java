...
public class UserController {
    ...
    ) Pageable pageable,@RequestParam("active") boolean isActive) throws ErrorException{
        Pagination<UserProject> pagignation = this.userService.getAll(pageable,isActive);
